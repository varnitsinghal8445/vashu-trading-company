...
const AlbumVideoBox = ({ videoSrc }) => {
  ...
  return (
    <motion.div 
      ...
      className="relative w-full max-w-5xl mx-auto my-20 rounded-2xl overflow-hidden shadow-2xl group cursor-pointer"
      ...
      <div className="absolute inset-[1px] rounded-2xl bg-black overflow-hidden z-10">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
          ...
          <motion.div 
            ...
            className="w-20 h-20 md:w-24 md:h-24 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm flex items-center justify-center mb-8 group-hover:border-secondary/50 group-hover:bg-secondary/10 transition-colors duration-500"
          >
            <Play className="w-8 h-8 md:w-10 md:h-10 text-white ml-2 opacity-80 group-hover:opacity-100 group-hover:text-secondary transition-all" />
          </motion.div>
          ...
          <div className="text-center mt-auto">
            ...
            <p className="text-gray-300 font-light text-sm md:text-base max-w-lg mx-auto leading-relaxed opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-700">
              From carefully selected photographs to handcrafted pages, every album is created to preserve your story.
            </p>
          </div>
        </div>
