...
const Footer = () => {
  return (
    <footer className="bg-primary/50 backdrop-blur-2xl border-t border-white/5 text-white pt-10 pb-6 relative z-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-2xl font-serif font-bold tracking-wider mb-3">Vasu Trading Company<span className="text-secondary">.</span></h2>
            <p className="text-gray-400 font-light text-xs max-w-sm">
          ...
          <div>
            <h4 className="text-base font-serif mb-4 text-secondary">Quick Links</h4>
            <ul className="space-y-2 font-light text-xs text-gray-400">
          ...
          <div>
            <h4 className="text-base font-serif mb-4 text-secondary">Services</h4>
            <ul className="space-y-2 font-light text-xs text-gray-400">
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500 font-light">
          <p className="font-light uppercase tracking-widest text-center">&copy; {new Date().getFullYear()} Vasu Trading Company. All rights reserved.</p>
